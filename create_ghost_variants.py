...
def create_variant_ghost(out_path, body_color, cheek_color, eye_color=[15, 17, 22, 255]):
    n_theta = 64
    n_height = 40
    ...
    body_mesh.visual.vertex_colors = body_color
    ...
    r_arm.visual.vertex_colors = body_color
    ...
    l_arm.visual.vertex_colors = body_color
    ...
    eye_l.visual.vertex_colors = eye_color
    ...
    eye_r.visual.vertex_colors = eye_color
    ...
    cheek_l.visual.vertex_colors = cheek_color
    ...
    cheek_r.visual.vertex_colors = cheek_color
    ...
    mouth.visual.vertex_colors = [25, 20, 25, 255]
    ...
    tongue.visual.vertex_colors = [255, 110, 140, 255]
...
# Generate Spooky Mint Ghost
create_variant_ghost("public/real_ghost_mint.glb", [210, 255, 245, 255], [0, 255, 200, 255])
# Generate Spooky Purple Ghost
create_variant_ghost("public/real_ghost_purple.glb", [235, 215, 255, 255], [176, 38, 255, 255])
